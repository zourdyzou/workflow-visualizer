  ...
  return (
    <div className="flex h-screen flex-col">
      <header className="border-b bg-white p-4">
        <h1 className="text-2xl font-bold text-gray-900">Workflow Management Visualizer</h1>
        <p className="text-sm text-gray-600">Netflix Conductor Workflow Visualization with React Flow</p>
      </header>

      <main className="flex-1">
        <WorkflowManagementVisualizer workflow={sampleWorkflow} />
      </main>
    </div>
  )
}
